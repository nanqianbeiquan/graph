...
model.events = {
    ...
    'smartAnalyseCalled': 'smartAnalyse',
...
//== start 渲染圆形树图 ==============================
function renderCluster(investRel){
    ...
    //== 模态框显示时的SVG界面大小
    var svgWidth = document.getElementById('modal-dialog').offsetWidth - 30;
    var svgHeight = document.documentElement.clientHeight - 130;
    var radius = d3.min([svgWidth,svgHeight])/2;
